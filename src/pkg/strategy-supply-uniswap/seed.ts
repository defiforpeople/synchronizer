...
export const Seed = async (storage: ISupplyUniswapStorage): Promise<SupplyUniswapStrategy[]> => {
  const strategies: SupplyUniswapStrategy[] = [
    {
  ...
  const results: SupplyUniswapStrategy[] = [];
